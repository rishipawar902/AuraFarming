...
JHARKHAND_DISTRICT_COORDINATES = {
...
# List of districts for easy access
JHARKHAND_DISTRICTS = list(JHARKHAND_DISTRICT_COORDINATES.keys())

def get_district_coordinates(district_name: str) -> dict:
    """
    ...
    """
    return JHARKHAND_DISTRICT_COORDINATES.get(district_name)

def get_all_districts() -> list:
    """Get list of all available districts."""
    return list(JHARKHAND_DISTRICT_COORDINATES.keys())

def is_valid_district(district_name: str) -> bool:
    """Check if a district name is valid."""
    return district_name in JHARKHAND_DISTRICT_COORDINATES