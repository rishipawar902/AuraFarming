...
from app.api.smart_advisory import smart_advisory_router
...
app.include_router(smart_advisory_router, prefix="/api/v1/smart-advisory", tags=["Smart Advisory System"])
